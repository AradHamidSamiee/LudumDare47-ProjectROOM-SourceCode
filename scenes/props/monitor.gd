...
func _on_Area_stand_body_entered(body):
	...
	if current_question == 7 or current_question == 8 or current_question == 15:
		jumpscare()
...
# Jumpscare
func jumpscare():
	var shadow_position = randi() % 4
	$shadow.show()
	if shadow_position == 0:
		$shadow.translation.x = 13
		$shadow.translation.z = 0
	elif shadow_position == 1:
		$shadow.translation.x = -14
		$shadow.translation.z = 0
	elif shadow_position == 2:
		$shadow.translation.x = 13
		$shadow.translation.z = 27
	elif shadow_position == 3:
		$shadow.translation.x = -14
		$shadow.translation.z = 27
